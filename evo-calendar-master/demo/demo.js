...
$(document).ready(function() {
    $("#demoEvoCalendar").evoCalendar({
        ...
        calendarEvents: [{
            id: "d8jai7s",
            name: "Maternal and Child Health Month",
            description: "Beginning of the Rotary year",
            date: "July/1/2024",
            type: "event",
            everyYear: !0
        },   {
         id: "d8jai7a",
        name: "Membership and New Club Development Month",
        description: "Service Project Center replaces Rotary Showcase",
        date: "August/1/2024",
        type: "event",
        everyYear: !0
    },
        {
            id: "sKn89hi",
            name: "Basic Education and<br> Literacy Month",
            // description: "Lorem ipsum dolor sit amet.",
            badge: "Whole Month",
